      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white shadow-2xl rounded-2xl p-8 hover:shadow-indigo-300 transition duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-lg text-white font-semibold bg-indigo-600 hover:bg-indigo-700 transition duration-300 flex items-center justify-center"
              disabled={isLoading}
            >
              {isLoading && (
                <svg
                ...
                >
                  ...
                  <path
                    ...
                    fill="currentColor"
                    d="M4 12a8 8 0 018-8v4l3.5-3.5L12 4v4a8 8 0 010 16 8 8 0 01-8-8z"
                  ></path>
                </svg>
              )}
